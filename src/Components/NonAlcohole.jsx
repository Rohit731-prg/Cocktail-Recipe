...
function NonAlcohole() {
  const navigate = useNavigate()
  const [details, setDetails] = useState(null)

  async function fetchData() {
    try {
      const responce = await fetch('https://www.thecocktaildb.com/api/json/v1/1/filter.php?a=Non_Alcoholic')
  ...
  return (
    <div className='w-full h-full pt-10 px-10 bg-[#F5EFFF]'>
        <p className='text-3xl font-serif w-full my-10'>Welcome to Non Alcohole Drinks List</p>
